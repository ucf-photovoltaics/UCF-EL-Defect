...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--threshold', default=.54, type=float, help='probability of defect threshold')
    parser.add_argument('--class-weights', action='store_true', help='weights for loss function')
    parser.add_argument('--num-classes', default=5, type=int, help='segmentation classes in dataset')
